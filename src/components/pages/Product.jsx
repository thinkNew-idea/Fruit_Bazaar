        ...
        <>
            <div className='flex flex-col'>
                ...
                <div className='flex flex-row pt-[2rem] px-[2rem]'>
                    <div onClick={handleFilter} className='cursor-pointer ml-[10px] py-[6px] px-5 flex border-[#3d3839] border-[1px] text-[#3d3839]  border-solid hover:bg-[#3d3839] hover:text-[#fff]'>
